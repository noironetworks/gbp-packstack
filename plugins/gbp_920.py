...
def initConfig(controller):
    params = [
        {"CMD_OPTION": "apic_app_profile_name",
         "USAGE": ("APIC Application Profile Name. Default Value is app. Valid values are any string"),
         "PROMPT": "Enter the APIC Application Profile Name.",
         "OPTION_LIST": [],
         ...
         "CONF_NAME": "CONFIG_APIC_APP_PROFILE_NAME",
         "USE_DEFAULT": False,
         "CONDITION": False},

        {"CMD_OPTION": "apic_vmm_domain",
         "USAGE": ("APIC VMM domain. Default Value is vmm Valid values are any string"),
         "PROMPT": "Enter the APIC VMM domain Name.",
         "OPTION_LIST": [],
         "VALIDATORS": [validators.validate_not_empty],
         "PROCESSORS": [],
         "DEFAULT_VALUE": "vmm",
         "MASK_INPUT": False,
         "LOOSE_VALIDATION": True,
         "CONF_NAME": "CONFIG_APIC_VMM_DOMAIN",
         "USE_DEFAULT": False,
         "CONDITION": False},

        {"CMD_OPTION": "apic_entity_profile",
         "USAGE": ("APIC Entity Profile. Default Value is openstack_aep Valid values are any string"),
         "PROMPT": "Enter the APIC Entity Profile Name.",
         "OPTION_LIST": [],
         "VALIDATORS": [validators.validate_not_empty],
         "PROCESSORS": [],
         "DEFAULT_VALUE": "openstack_aep",
         "MASK_INPUT": False,
         "LOOSE_VALIDATION": True,
         "CONF_NAME": "CONFIG_APIC_ENTITY_PROFILE",
         "USE_DEFAULT": False,
         "CONDITION": False},
        ...
        {"CMD_OPTION": "opflex_peer_ip",
         "USAGE": ("The IP address the OpFlex Peer"),
         "PROMPT": "Enter the IP address of the OpFlex Peer",
         "OPTION_LIST": [],
         "VALIDATORS": [validators.validate_not_empty],
         "PROCESSORS": [],
         "DEFAULT_VALUE": "10.0.0.30",
         "MASK_INPUT": False,
         "LOOSE_VALIDATION": True,
         "CONF_NAME": "CONFIG_OPFLEX_PEER_IP",
         "USE_DEFAULT": False,
         "CONDITION": False},

        {"CMD_OPTION": "opflex_remote_ip",
         "USAGE": ("The Remote IP address of OpFlex"),
         "PROMPT": "Enter the IP address of the APIC controller",
         "OPTION_LIST": [],
         "VALIDATORS": [validators.validate_not_empty],
         "PROCESSORS": [],
         "DEFAULT_VALUE": "10.0.0.32",
         "MASK_INPUT": False,
         "LOOSE_VALIDATION": True,
         "CONF_NAME": "CONFIG_OPFLEX_REMOTE_IP",
         "USE_DEFAULT": False,
         "CONDITION": False},
